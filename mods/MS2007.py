...
class MS2007:
    def __init__(self,A1x=5.4,A2x=5.4,hx=3,phx=-95,A1y=2.7,A2y=5.4,hy=2,phy=-25,w=2*pi/4.5,ox=0,oy=0):
    ...
    def update(self,dt):
        ...
        self.y=self.A1y*cos(self.hx*self.w*self.t)+self.A2y*cos(self.hy*self.w*self.t-self.phy)+self.oy